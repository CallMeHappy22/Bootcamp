                ...
                <div class="col-md-10">
                    <h5 class="labelhead">
                        <div class="alert alert-secondary d-flex justify-content-between align-items-center" role="alert">
                            ...
                            <form id="frm2" onchange="submitForm()" action="sort-product" method="post">
                        ...
                        <%@include file="../component/navPagingSortByAll.jsp" %>
                        <div class="row mb-5">
                                        ...
                                        <div class="col-md-3 mt-4 pt-2">
                                            <div class="card">
                                                ...
                                                <div class="card-body pt-3">
                                                    ...
                                                    <p class="text-center my-0" style="color: #f60"><fmt:formatNumber type="currency" value="${product.price}"/></p>
                                                </div>
                                            </div>
                                        </div>
