<%-- 
    Document   : ModalEditAccount
    Created on : Nov 5, 2019, 9:53:37 AM
    Author     : ThinkPro
--%>
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="frmEditAccount" class="modal-content animate" style="padding: 5px;border-top:none;border-bottom: none" action="edit-account" method="post">
            ...
            <div class="modal-footer">
                ...
                <button type="button" onclick="document.getElementById('frmEditAccount').submit()" class="btn btn-primary">Lưu thay đổi</button>
            </div>
        </div>
    </div>
</div>
