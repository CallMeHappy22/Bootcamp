 ...
 * @author ThinkPro
 */
@WebServlet(name = "ListAllProductSalling", urlPatterns = {"/get-list-sale"})
public class ListAllProductSalling extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getSession().setAttribute("url", "get-list-sale");
